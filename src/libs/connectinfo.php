<?php
	if(!empty($_SESSION['nickname']) && !empty($_SESSION['password'])){
	    ...
	    if($result['class']=="admin"){
	        echo '<div id="container"><a href="./"><button>Go to home</button></a><a href="skytalk/"><button>SkyTalk</button></a><a href="admin/"><button>Go to admin panel</button></a><a href="account/signout.php"><button>Sign out</button></a></div>';
	    }else{
	        echo '<div id="container"><a href="./"><button>Go to home</button><a href="skytalk/"><button>SkyTalk</button></a></a><a href="account/signout.php"><button>Sign out</button></a></div>';
	    }
    }else{
