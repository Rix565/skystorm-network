...
<body>
	...
	?>
	<div id="container">
		<a href="balancemanagement.php"><button>Go to the balance management system</button></a><a href="skytalkmanagement.php"><button>Go to the SkyTalk Management</button></a><a href="../"><button>Go to home</button></a>
	</div>
	<?php
